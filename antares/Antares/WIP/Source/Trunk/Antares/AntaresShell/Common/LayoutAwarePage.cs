    ...
    public class LayoutAwarePage : Page
    {
        ...
        public LayoutAwarePage()
        {
            ...
            Loaded += (sender, e) =>
            {
                ...
                if (Math.Abs(ActualHeight - Window.Current.Bounds.Height) < EPSILON &&
                    Math.Abs(ActualWidth - Window.Current.Bounds.Width) < EPSILON)
                {
        ...
        protected virtual void GoHome(object sender, RoutedEventArgs e)
        {
            ...
            if (Frame != null)
            {
                NavigatorProvider.Navigator.Instance.HideNotificator();
                NavigatorProvider.Navigator.Instance.BottomAppBar.IsOpen = false;
                NavigatorProvider.Navigator.Instance.TopAppBar.IsOpen = false;
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            else
            {
                ...
                if (e.Parameter != null && e.Parameter.ToString() == "#1:")
                {
                    LoadState(null, (Dictionary<String, Object>)frameState[_pageKey]);
                }
                else
                {
